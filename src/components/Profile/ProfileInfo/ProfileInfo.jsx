	...
	return (
		<div className={s.info}>
			<div className={s.avatar}>
				<img className={s.avatarPic} src={props.profile.photos.large ? props.profile.photos.large : def_profile} alt="Profile" />
						...
						<div className={s.userInfo_left}>
							<ul className={s.info_middle_left}>
								...
								{props.profile.lookingForAJobDescription ?
									<li className={s.job_description}>
										<img className={s.job_description_icon} src={job_desc} alt={"About"} />
							...
							<ul className={s.contacts}>
								{props.profile.contacts.facebook ?
									<li>
										<a className={s.contacts_link} href={props.profile.contacts.facebook} target={"_blank"} rel="noreferrer">
											<svg className={s.icon} viewBox="0 0 24 24" width="15" height="15">
												<g>
